/*
O "IllegalArgumentException" é lançado quando o argumento de um método é passado de maneira imprópria.
O "NumberFormatException" é lançado para indicar que o aplicativo tentou converter uma string em int ou float, acaba falhando
*/

public class QE1_Main {
